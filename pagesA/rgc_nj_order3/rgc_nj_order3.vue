<template>
	<view class="wrap_box">
		...
		<view class="steps_box">
			<u-steps current="3" :dot="true" inactiveColor="#EEEEEE" activeColor="#4680E6">
		...
		<view class="tip_box dis_flex_c aic ju_c">
			<image class="tip_img" src="/static/images/order_ok.png" mode="aspectFit"></image>
			<view class="tip_d1">已寄出</view>
			<view class="tip_d2">标志派送中，请您及时查收</view>
		</view>
		<view class="cz_box">
