<template>
	<view class="wrap_box">
		...
		<view class="main_box">
			<image v-if="navdata[6].banner" class="main_bg" :src="$service.getimg(navdata[6].banner)" mode="widthFix"></image>
			<image v-else class="main_bg" :src="$service.getimg('/static_wx/images/rgcwz_bg.png')" mode="widthFix"></image>
			<view class="cz_box">
				...
				<view class="xq_li fww">
					...
					<view class="pz_btn" @click="$service.jump" data-url="/pagesA/pzsb/pzsb?type=4">
